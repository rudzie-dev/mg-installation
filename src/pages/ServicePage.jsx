...
const WA_ICON = () => (
  <svg viewBox="0 0 32 32" fill="currentColor" className="w-5 h-5 flex-shrink-0 select-none">
...
export const SERVICES = {
  cctv: {
    ...
    gallery: ["/images/ColorVu-Camera.webp", "/images/ColorVu-Camera2.webp", "/images/ColorVu-Camera3.webp"],
    review: { text: "MG sorted our CCTV the same day I called. The wiring is invisible and the phone app works perfectly.", name: "Thabo M.", location: "Ladysmith" },
  ...
  dstv: {
    ...
    gallery: ["/images/Dstv1.webp", "/images/Dstv2.webp"],
    review: { text: "My DSTV signal has been flawless since MG came out. He fixed everything properly.", name: "Priya N.", location: "Ladysmith" },
  ...
  repairs: {
    ...
    gallery: ["/images/Installer.webp", "/images/installer2.webp"],
    review: { text: "Called at 9am, he was here by 11. Fixed a camera that two other guys couldn't sort out.", name: "Farhan A.", location: "Ladysmith" },
...
const fadeUp = (delay = 0) => ({
  ...
  style: { willChange: "transform, opacity" }, // Hardware acceleration forced
          ...
          <motion.div initial={{ opacity: 0, x: -16 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center">
              ...
              <a href="tel:0606038238"
                ...
                <Phone className="w-4 h-4 text-[#57534E] flex-shrink-0" /> <span>060 603 8238</span>
              </a>
            </div>
          </motion.div>
          ...
          <div className="relative z-10 flex flex-col items-center text-center px-8 py-20 gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full max-w-sm items-stretch sm:items-center">
              ...
              <a href="tel:0606038238"
                ...
                <Phone className="w-4 h-4 flex-shrink-0" /> <span>Call Now</span>
              </a>
            </div>
          </div>
        </motion.div>
