          ...
          <div className="md:col-span-4 flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2.5 text-sm font-semibold text-[#1C1917]">
              <a href="tel:0606038238" aria-label="Call MG Installations at 060 603 8238" 
                ...
                <Phone className="w-4 h-4 text-[#2563EB]" aria-hidden="true" /> 060 603 8238
              </a>
              <a href="mailto:info@mginstallations.co.za" aria-label="Email MG Installations at info@mginstallations.co.za"
                className="flex items-center gap-2 hover:text-[#2563EB] transition-colors w-fit">
